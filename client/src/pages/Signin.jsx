  ...
  return (
    <>
      <div className="w-96 mx-auto mt-20 p-4 bg-white shadow-md rounded-md">
        <h1 className="text-xl text-center mb-3 ">Sign In</h1>
        <form onSubmit={handleSubmit}>
          ...
          <button
            className="w-full disabled:opacity-80 rounded-lg p-2 bg-slate-700 hover:opacity-95 text-white uppercase"
            type="submit"
          >
            Sign In
          </button>
